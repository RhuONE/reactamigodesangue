    ...
    return (
        <>
            ...
            >
                ...
                <ul>
                    <li className={location.pathname === '/laboratorio/exames-pendentes' ? 'active' : ''}>
                        <Link to='/laboratorio/exames-pendentes'> <FaUserCheck /> <p>Pendentes</p></Link>
                    </li>
                    ...
                    <li className={location.pathname === '/laboratorio/historico-exames' ? 'active' : ''}>
                        <Link to='/laboratorio/historico-exames'> <FaClipboardList /> <p>Histórico</p></Link>
                    </li>
...
export default SidebarLaboratorio;
